      ...
      <div className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center">
          ...
          <div className="flex space-x-4">
            {" "}
            <button
              className="bg-white text-black py-2 px-4 rounded-full font-semibold hover:bg-gray-200"
      ...
      <div className="bg-yellow-500 min-h-screen flex items-center justify-center px-4 md:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <button
              className="bg-gray-900 text-white py-3 px-6 rounded-full font-semibold hover:bg-gray-700"
              onClick={() => navigate("/login?form=signup")}
            >
              Start Contributing
            </button>
